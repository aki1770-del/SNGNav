...
///
/// The BLoC sees only a stream of [GeoPosition] — no changes needed.
/// Dead reckoning positions have degrading accuracy so the BLoC correctly
/// transitions from `fix` → `degraded` as uncertainty grows.
///
...
import '../models/dead_reckoning_state.dart';
...
class DeadReckoningProvider implements LocationProvider {
  ...
  /// Default: 3 seconds. This is shorter than the BLoC stale threshold (10s)
  /// so DR starts before the UI shows "stale".
