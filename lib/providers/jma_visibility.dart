...
// source-neutral (shared with the Digitraffic provider); re-exported so
// importers of this file resolve `VisibilityObservation` and
// `mergeObservedVisibility` directly, mirroring `digitraffic_visibility.dart`.
