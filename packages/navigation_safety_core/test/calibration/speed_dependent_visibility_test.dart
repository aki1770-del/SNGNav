import 'package:navigation_safety_core/src/calibration/speed_dependent_visibility.dart';
...
void main() {
  group('computeSpeedAdjustedVisibilityMeters', () {
    ...
    test('low speed (≈60 km/h, 16.7 m/s) under experienced RT keeps baseline', () {
    ...
    test('high speed (≈100 km/h, 27.8 m/s) under novice RT raises threshold', () {
    ...
    test('professional RT yields shorter required distance than novice at same speed', () {
    ...
    test('foreign-tourist on highway (35 m/s, 3.5s RT) requires substantial floor', () {
