...
void main() {
  group('forProfileWithContext + vehicleOverrides', () {
    ...
    test('kei-car token raises warning thresholds vs baseline-plus-context', () {
      final baselineCtx = NavigationSafetyConfig.forProfileWithContext(
    ...
    test('kei-car composes with humidity + ambient (override applied last)', () {
    ...
    test(
      ...
      expect(baselineCtx.criticalVisibilityMeters,
          raw.criticalVisibilityMeters);
      expect(baselineCtx.criticalTemperatureCelsius,
    ...
    test('all six profiles compose with kei-car override (smoke + invariants)',
        () {
