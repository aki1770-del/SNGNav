...
# line gets the DEFECTIVE release. That is a silent recall,
...
# This is the cheap mechanical check for the
...
for p in "${pkgs[@]}"; do
  ...
  # wolf, and a check that cries wolf gets ignored on the day it is right.
