...
void main() {
  test(
    'Sprint 52 target packages resolve together in one integration context',
    () {
      ...
      expect(
        S52TestFixtures.nagoyaToOkazakiRequest.origin,
        equals(S52TestFixtures.nagoya),
      );
      expect(S52TestFixtures.nagoyaToOkazakiRoute.hasGeometry, isTrue);
      expect(
        S52TestFixtures.nagoyaToOkazakiRoute.engineInfo.name,
        equals('mock-s52'),
      );
    },
  );
